...
=== "Power grids around the world"
    <div id="tag-filters" class="tag-filter"></div>
    ??? info "Global Data Catalogs (Click Me)"
        * [Open Infrastructure Map](https://openinframap.org/) [[Code](https://github.com/openinframap/openinframap)] (map)
        * [GridFinder](https://gridfinder.rdrn.me/) [[Code](https://github.com/carderne/gridfinder)]  (2025) (ODBL) (report)
        * [FLOSM Power Grid](https://www.flosm.org/en/powergrid.html)
        * [Electricity Maps - Electricity Grid Carbon Emissions](https://app.electricitymaps.com/) [[Code](https://github.com/electricitymaps/electricitymaps-contrib)] (2025)(dataset)
        * [Global Energy Monitor](https://globalenergymonitor.org/)
        * [The Global Transmission Database](https://github.com/Electricity-Transmission-Database/electricity-transmission-database) [Code](https://github.com/Electricity-Transmission-Database/electricity-transmission-database) (dataset;capacitydata) (2025)
        * [HVDC World Global Map](https://www.hvdcworld.com/hvdc-map)  (2025) (Odbl)  (report)
        * [ENERGYDATA.INFO](https://energydata.info/) 
        - Open Data and Analytics for a sustainable energy future (report,dataset)
        * [Transmission network datasets wiki of openmod](https://wiki.openmod-initiative.org/wiki/Transmission_network_datasets) 
        * [Open Energy Platform Grid Data](https://openenergyplatform.org/dataedit/view/grid) (report;capacitydata)
        * [Electricitymaps Data Sources](https://github.com/electricitymaps/electricitymaps-contrib/blob/master/DATA_SOURCES.md) (report)
        * [openAfrica](https://www.open.africa/)(map; capacitydata)
        * [Global Renewables Watch](https://www.globalrenewableswatch.org/)
        * [The Utility Performance and Behavior Today (UPBEAT) platform - WorldBank](https://utilityperformance.energydata.info/utilities/) (map)
        * [Latin America UPME electricity infraestructure map](https://sig.upme.gov.co/portal/apps/experiencebuilder/experience/?id=1cb0108edbcb48aca70a838db3db6d89&page=Infraestructura-el%C3%A9ctrica&views=LATAM) (dataset)
        * [Energy Access Explorer](https://www.energyaccessexplorer.org/)

    ??? info "Africa (Click Me)"
        ### <div class="tools-header">Cross-border projets and resources</div>
        * [Africa Electricity Grids Explorer](https://africagrid.energydata.info/)
        * [Central Africa Power Pool](https://www.peac-sig.org/en/systeme-d-information-3.html) (report) (2025) (OBDL)
        * [Africa Knowledge Platform-European Comission](https://africa-knowledge-platform.ec.europa.eu/explore_maps) (dataset;capacitydata)
        * [ECOWAS Region - Existing and Planned Transmission Grid](https://energydata.info/dataset/transmission-grid-ecowas-region) (dataset)
        ...
        * [Med-TSO - Mediterranean](https://med-tso.org/en/map-of-the-interconnected-electricity-transmission-networks-2024/) (map)
        ...
        * [Southern-Eastern Africa RE Zones](https://mapre.es.ucsb.edu/project/searez/) (report; capacitydata)
        * [West African Power Pool (WAPP) - 2017](https://www.ecowapp.org/sites/default/files/wapp_map_general_optimized.gif) (dataset)
        * [West African Power Pool (WAPP) - 2019](https://www.ecowapp.org/sites/default/files/wapp_final_map_0.pdf) (map)

        ### <div class="tools-header">National-level projets and resources</div>
        * (Angola) [Rapid Assessment and Gap Analysis](https://www.seforall.org/sites/default/files/l/2015/05/Angola_RAGA.pdf)
        * (Benin;Burkina Faso;Côte d'Ivoire;Ghana;Guinea;Guinea-Bissau;Liberia;Mali;Niger;Nigeria;Senegal;Sierra Leone;Togo;Gambia) [West African Power Pool (WAPP) - 2017](https://www.ecowapp.org/sites/default/files/wapp_map_general_optimized.gif) (dataset)
        * (Cameroon) [Plan Directeur d’Electrification Rurale](https://rise.esmap.org/data/files/library/cameroon/Electricity%20Access/Cameroon_PDER.pdf) (dataset)
        * (Democratic Repulic of the Congo) [Regulator Report 2024](https://are.gouv.cd/rapport-annuel-2024/) (report; capacitydata)
        * (Eswatini) [Energydata Eswatini Substations 2021](https://energydata.info/dataset/eswatini-substations) (report)
        * (Eswatini) [Energydata Eswatini Grid Network 2022](https://energydata.info/dataset/eswatini-grid-network) (dataset; capacitydata)
        * (Eswatini) [Energydata Eswatini Electricity Transmission Network 2009](https://energydata.info/dataset/swaziland-electricity-transmission-network) (dataset)
        * (Eswatini) [Energydata Eswatini Power Plants](https://energydata.info/dataset/swaziland-power-plants) (map)
        * (Ethiopia) [Electric Power](https://www.eep.com.et/?page_id=781) (report)
        ...
        * (Gabon) [Energydata Gabon Power Plants](https://energydata.info/dataset/gabon-power-plants) (map)
        ...
        * (Kenya) [Energydata Kenya Electricity Network](https://energydata.info/dataset/kenya-kenya-electricity-network) (dataset)
        * (Kenya) [Energydata Kenya Transmission Stations](https://energydata.info/dataset/kenya-transmission-stations)
        * (Kenya) [Energydata Kenya Primary Substations](https://energydata.info/dataset/kenya-primary-substations) (map)
        ...
        * (Madagascar) [Energydata Madagascar planned transmission network 2017](https://energydata.info/dataset/madagascar-planned-transmission-network-2017) (map)
        * (Mauritania) [Energydata Mauritania Existing Grid](https://energydata.info/dataset/mauritania-existing-grid) (dataset)
        ...
        * (Nigeria) [THE ENERGY YEAR - Nigeria Grid Map 2021](https://d3jmgibn6sgz2k.cloudfront.net/wp-content/uploads/2021/11/09164603/TCN_Nigeria21.pdf) (dataset)
        ...
        * (Somalia) [Mini-Grids With MV Lines](https://energydata.info/dataset/somalia-mini-grids-with-mv-lines) (dataset)
        ...
        * (Uganda) [Energydata Transmission Substations 2016](https://energydata.info/dataset/transmission-substations-2016-operational) (2016) (dataset)
        ...
        * (Zambia) [Energydata Zambia Overhead MV Distribution Lines](https://energydata.info/dataset/zambia-overhead-mv-distribution-lines) (dataset)
        * (Zambia) [Energydata Zambia Base case grid extensions](https://energydata.info/dataset/zambia-base-case-grid-extensions)
        * (Zambia) [Energydata Zambia Power plants 2015](https://energydata.info/dataset/zambia---power-plants--2015-) (2015)
        ...
        * (Zambia) [Energydata Zambia Electricity Transmission Network 2014](https://energydata.info/dataset/zambia-electricity-transmission-network-2014) (2014)
    ...
    ??? info "Australia and New Zealand (Click Me)"
    ...
    ??? info "Europe (Click Me)"
        ...
        * (Albania;Bosnia and Herzegovina;Kosovo;North Macedonia;Montenegro;Serbia) [Transmission grid in the Western Balkans](https://wb6energyprospect.com/maps.php?mapa=6)
        ...
        * (Bosnia and Herzegovina) [Map of EES 2024](https://www.derk.ba/en/ees-bih/ees-map)
...
=== "News and science publications"
    ??? info "Scientific Publications (Click Me)"
    ...
    ??? info "Reports and News (Click Me)"    
...
=== "Even more resources"
    ??? info "Presentations and Videos (Click Me)"
        * [Pinpointing the power grid](https://www.youtube.com/watch?v=KlZ1ijWxKkw) (2025)
    ...
    ??? info "Grid Extraction, Transformation and Integration Tools (Click Me)"
    ...
    ??? info "Remote mapping (Click Me)"
        ...
        * [gridfinder - Dataset](https://zenodo.org/records/3628142)
        ...
        ### <div class="tools-header">TTPLA</div>
        ...
        * [TTPLA Dataset](https://github.com/r3ab/ttpla_dataset)
        ...
        ### <div class="tools-header">PGRID</div>
        ...
        * [turkana-grid-mapping - Repository](https://github.com/USAFORUNHCRhive/turkana-grid-mapping)
        ...
        ### <div class="tools-header">Multi-Size Power Line Assets Detection in High-Resolution UAV Images</div>     
        * [STN PLAD](https://github.com/andreluizbvs/PLAD)
    
        ### <div class="tools-header">GridTracer</div>
        * [GridTracer - Automatic Mapping of Power Grids using Deep Learning and Overhead Imagery](https://arxiv.org/abs/2101.06390)
        ...
        * [Inferring Energy Infrastructure - Code](https://github.com/pypsa-meets-earth/detect-energy)
        ...
        ### <div class="tools-header">Substation detection</div>
        ...
        * [Substation detection on NSO imagery - Paper](https://iopscience.iop.org/article/10.1088/2634-4505/ad63c9/meta)
        ...
        ### <div class="tools-header">Embeddings and GIS Foundation Models</div>
    ...
    ??? info "Crowdsourced mapping (Click Me)"
        ### <div class="tools-header">Communities and Initiatives</div>
        * [Humanitarian OpenStreetMap Team](https://www.hotosm.org/)
        * [Youthmappers - Mapping for a sustainable future: YouthMappers tackleglobal climate challenges](https://www.preventionweb.net/news/mapping-sustainable-future-youthmappers-tackle-global-climate-challenges)
        ...
        * [Youthmappers - Power Grid Mapping in West Africa](https://www.researchgate.net/publication/365837549_Power_Grid_Mapping_in_West_Africa)
        ...
        ### <div class="tools-header">Challenges</div>
        ...
        * [MapRoulette](https://maproulette.org/)
        ...
        ### <div class="tools-header">Tutorials and Training</div>
    ...
    ??? info "Electrical Grid Mapping in OpenStreetMap (Click Me)"
        ### <div class="tools-header">Forums and Community</div>
        ...
        * [Infrastructure Matrix Channel](https://app.element.io/#/room/#osm-infrastructure:matrix.org)
        ...
        ### <div class="tools-header">Power Tags and Articles</div>
        ...
        * [Key:proposed](https://wiki.openstreetmap.org/wiki/Key:proposed) 
        ...
        ### <div class="tools-header">Good Practices in Power Routing</div>
        * [Power Routing Proposal](https://wiki.openstreetmap.org/wiki/Proposal:Power_routing_proposal) [[Talk](https://wiki.openstreetmap.org/wiki/Proposal_talk:Power_routing_proposal)]
        ...
        ### <div class="tools-header">Statistics</div>
        ...
        * [Filtering OSM Changesets by a Specific Text of the last 30 Days](https://resultmaps.neis-one.org/)
        ...
        ### <div class="tools-header">Quality Assurance Tools</div>
        ...
        * [OsmNightWatch](https://github.com/DavidKarlas/OsmNightWatch)
        ...
        ### <div class="tools-header">Desktop Editors and Mapping Tools</div>
    ...
    ??? info "Grid Design Basics (Click Me)"
        ### <div class="tools-header">Theory</div>
        ...
        * [Comparison between HVAC and HVDC transmission system](https://www.youtube.com/watch?v=l9nHs8e0WUg)
        ...
        ### <div class="tools-header">Grid Design</div>
        ...
        * [Let's trace the power lines all the way to the power plant](https://www.youtube.com/watch?v=UBt1uJuz0-4&list=PLXb3r5ny8_1Xkd9Ht6wiQEAiF1mtAfmGS&index=32)
        ...
        ### <div class="tools-header">Voltage Estimation</div>
